...
{
    numberOfPackets++;
    NSDictionary *dictionary = [NSDictionary dictionaryWithObject:[NSNumber numberWithInt:numberOfPackets] forKey:@"NumOfPackets"];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"Packets/Sec" object:nil];
    //[[NSNotificationCenter defaultCenter] postNotificationName:@"Packets/Sec" object:nil userInfo:dictionary];
}
